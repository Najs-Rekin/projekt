...
namespace RPG_project
{
    internal class Spels
    {
        ...
        {
            Console.WriteLine($"1 - Lecznie \t 2 - zwiększenie ataku \t 3 - iskierki ~~ Ciekawe co to? Nie uważasz, że trzeba sprawdzić? ");
        ...
        { 
            if (character[2] >= 100)
            {
                ...
                Console.WriteLine("iskierki cię otoczyły i udusiły, więc finalnie - UMIERASZ!");
                return character;
            }
            else
            {
